...
class EventView extends StatefulWidget {
  ...
  @override
  State<EventView> createState() => _nameState();
}

class _nameState extends State<EventView> {
  final eventService = EventService();
  //Danh sách sự kiện
  List<EventModel> items = [];

  //Tạo CalendarController để điiều khiển SfCalendar
  final calendarControler = CalendarController();

  @override
  void initState() {
    super.initState();
    calendarControler.view = CalendarView.day;
    loadEvents();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<CalendarView>(
            ...
            icon: getCalendarViewIcon(calendarControler.view!),
          ),
          IconButton(
            onPressed: () {
              calendarControler.displayDate = DateTime.now();
            },
      ...
      body: SfCalendar(
        ...
        onTap: (details) {
          //Khi nhấn vào sự kiện ->sửa hoặc xóa
